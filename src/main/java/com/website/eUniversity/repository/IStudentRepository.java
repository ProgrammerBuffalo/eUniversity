...
public interface IStudentRepository extends JpaRepository<Student, Integer> {
    ...
    @Query(value = "SELECT new com.website.eUniversity.model.dto.entity.account.StudentDTO(a.id, s.id, a.fullName, a.age, a.login, a.password, g.name)" +
    ...
    @Query(value = "SELECT new com.website.eUniversity.model.dto.entity.account.StudentDTO(s.account.id, s.id, s.account.fullName, s.account.age, s.account.login, s.account.password)" +
